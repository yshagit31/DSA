// link - https://www.geeksforgeeks.org/problems/print-adjacency-list-1587115620/1?utm_source=youtube&utm_medium=collab_striver_ytdescription&utm_campaign=print-adjacency-list
...
class Solution {
  public:
    ...
    vector<vector<int>> printGraph(int V, vector<pair<int,int>>edges) {
        ...
        {
            Adj[edges[U].first].push_back(edges[U].second);
            Adj[edges[U].second].push_back(edges[U].first);
